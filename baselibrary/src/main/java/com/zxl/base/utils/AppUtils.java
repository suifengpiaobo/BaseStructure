 ...
 * Created by zxl on 2017/5/27 下午4:51.
...
public class AppUtils {
    ...
    public static boolean installAppSilent(String filePath) {
        ...
        ShellUtils.CommandResult commandResult = ShellUtils.execCmd(command, !isSystemApp(ContextUtils.getInstance().getContext()), true);
    ...
    public static boolean isAppRoot() {
        ...
        if (result.errorMsg != null) {
            LogUtils.deBug("isAppRoot", result.errorMsg);
        }
        return false;
    }
