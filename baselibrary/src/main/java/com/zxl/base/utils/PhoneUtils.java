...
/**
 * Description 手机相关工具类
 * Created by zxl on 2017/5/27 下午4:46.
...
public class PhoneUtils {
    ...
    public static String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) ContextUtils.getInstance().getContext()
    ...
    public static void dial(String phoneNumber) {
        ContextUtils.getInstance().getContext().startActivity(new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + phoneNumber)));
    }
    ...
    public static void call(String phoneNumber) {
        ContextUtils.getInstance().getContext().startActivity(new Intent("android.intent.action.CALL", Uri.parse("tel:" + phoneNumber)));
    }
    ...
    public static void sendSmsSilent(String phoneNumber, String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(ContextUtils.getInstance().getContext(), 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = ContextUtils.getInstance().getContext().getContentResolver();
